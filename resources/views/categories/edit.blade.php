...
@section('content')
    <h1 class="text-4xl font-bold font-space text-white mb-8">Edit Category</h1>
    ...
    <div class="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-xl shadow-lg p-8 max-w-lg mx-auto">
        <form action="{{ route('categories.update', $category->id_category) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="category_name" name="category_name" class="w-full bg-gray-900/70 border border-gray-700 rounded-lg shadow-sm focus:ring-purple-500 focus:border-purple-500 transition" value="{{ old('category_name', $category->category_name) }}" required>
            </div>
